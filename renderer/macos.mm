...
static void handle_key_event(window_t *window, int virtual_key, char action) {
    ...
    switch (virtual_key) {
        ...
        case 0x12: key = KEY_1;     break;
        case 0x13: key = KEY_2;     break;
        case 0x14: key = KEY_3;     break;
        case 0x15: key = KEY_4;     break;
        case 0x17: key = KEY_5;     break;
        case 0x18: key = KEY_PLUS;  break;
        case 0x1B: key = KEY_MINUS; break;
